...
import type { Company, QueryConsoleExample, TabId } from "@/types";
...
function HomeShell() {
  ...
  const [activeQuery, setActiveQuery] = useState<QueryConsoleExample | null>(null);
  ...
  const handleQuerySubmit = (example: QueryConsoleExample) => {
